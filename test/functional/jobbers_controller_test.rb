...
class JobbersControllerTest < ActionController::TestCase
  ...
  test "should create jobber" do
    assert_difference('Jobber.count') do
      post :create, jobber: { category: @jobber.category, country: @jobber.country, donation_amt: @jobber.donation_amt, job_description: @jobber.job_description, organization: @jobber.organization }
    end
  ...
  test "should update jobber" do
    put :update, id: @jobber, jobber: { category: @jobber.category, country: @jobber.country, donation_amt: @jobber.donation_amt, job_description: @jobber.job_description, organization: @jobber.organization }
    assert_redirected_to jobber_path(assigns(:jobber))
  end
